...
def _preprocess_observation(observation):
  ...
  #  observation = observation[0:404, :]
    ...
    return misc.imresize((255 - image.astype(np.uint8)), (47, 47)).ravel()

class PolicyNet(nn.Module):
    def __init__(self):
        super(PolicyNet, self).__init__()

        self.fc1 = nn.Linear(2209, 128)
        self.fc2 = nn.Linear(128, 64)
        self.fc3 = nn.Linear(64, 1)  # Prob of Left
    ...
    for e in range(num_episode):
       ...
       # env.render(mode='rgb_array')
        ...
        for t in count():
            ...
            next_state = _preprocess_observation(next_state)
            #env.render(mode='rgb_array')
